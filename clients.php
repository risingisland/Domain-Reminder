<?php
	...
	if(count($rows)>0){
		foreach($rows as $rr){
			...
			$editable='<a href="clients-add.php?id='.$rr["id"].'" ><i class="fas fa-edit"></i></a>';  
			...
			$files_table .= '<td><a href="clients-add.php?id='.$rr["id"].'">'.$rr["name"].'</a></td>';
			$files_table .= '<td class="company-name">'.$rr["company"].'</td>';
			...
			$files_table .= '<tr><td> <button type="submit" class="btn btn-block btn-danger del-confirm" title="'.$lang['DELETE_SELECTED'].'"><i class="fas fa-trash-alt"></i></button> </td></tr>';

			} else { 
			//0 files found in database. ( end of IF mysqli_num_rows > 0 )
			$files_table .= '<tr><td colspan="7">'.$lang['0_CLIENTS_IN_DB'].'</td></tr>';
			}

			$direction=($_SESSION["adm_clients.direction"]=='DESC')?('ASC'):('DESC');
			...
			<nav class="main-header navbar navbar-expand navbar-white navbar-light">
				...
				<form class="form-inline ml-3">
					<div class="input-group input-group-sm">
						<input class="form-control form-control-navbar search-bar" type="search" placeholder="Search" aria-label="Search">
				...
				<div class="sidebar">
					...
					<nav class="mt-2">
						<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
							...
							<li class="nav-item">
								<a href="clients.php" class="nav-link active"> <i class="nav-icon fas fa-users"></i>
			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-12">
								<h1 class="m-0 text-primary"><i class="fas fa-users"></i> <?php echo $lang['CLIENTS']; ?></h1> 
							</div>
							<!-- /.col -->
						</div>
						<!-- /.row -->
					...
					<div class="col-lg-12">
						<div class="card card-primary card-outline">
							<div class="card-body p-0">
								...
								<form enctype="multipart/form-data" action="clients.php" method="post" name="ff2">
										...
										<table class="table table-striped">
											<thead>
												<tr>
													...
													<th><strong><a onclick="document.ff2.orderBy.value='name'; document.ff2.direction.value='<?php echo $direction?>'; document.ff2.submit();" style="cursor:pointer;"><?php echo $lang['CLIENT_NAME']; ?></a>&nbsp;<?php if($_SESSION["adm_clients.orderBy"]=="name"){ ?><img src="assets/img/<?php echo strtolower($direction)?>.png" /><?php } ?></strong></th>
													
													<th><strong><a onclick="document.ff2.orderBy.value='company'; document.ff2.direction.value='<?php echo $direction?>'; document.ff2.submit();" style="cursor:pointer;"><?php echo $lang['CLIENT_COMPANY']; ?></a>&nbsp;<?php if($_SESSION["adm_clients.orderBy"]=="company"){ ?><img src="assets/img/<?php echo strtolower($direction)?>.png" /><?php } ?></strong></th>
											...
											<tbody>
												...
												<tr>
													<td colspan="4" align="right" class="paging">
									...
									<input type="hidden" name="orderBy" value="<?php echo $_SESSION["adm_clients.orderBy"]?>">
									<input type="hidden" name="direction" value="<?php echo $_SESSION["adm_clients.direction"]?>">
